            ...
            {destination.offers.map((offer) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <Link
                    href="/#form"
                    className="ui-btn ui-cta mt-4 inline-flex w-full items-center justify-center bg-terracotta px-4 py-2.5 text-sm font-semibold text-white hover:bg-terracotta-dark sm:w-auto"
                  >
                    Забронювати
                  </Link>
                </div>
